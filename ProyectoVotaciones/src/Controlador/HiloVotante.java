...
public class HiloVotante extends Thread {
    ...
    private String calcularPartido(int numero) {
        ...
        if (rangoEdad.equals("18_25")) {
            if (numero <= 30) return "PP";
            else if (numero <= 50) return "PSOE";
            else if (numero <= 70) return "VOX";
            else return "SALF";
        }

        if (rangoEdad.equals("26_40")) {
            if (numero <= 20) return "PP";
            else if (numero <= 55) return "PSOE";
            else if (numero <= 85) return "VOX";
            else return "SALF";
        }

        if (rangoEdad.equals("41_65")) {
            if (numero <= 10) return "PP";
            else if (numero <= 55) return "PSOE";
            else if (numero <= 90) return "VOX";
            else return "SALF";
        }

        if (rangoEdad.equals("MAS_66")) {
            if (numero <= 25) return "PP";
            else if (numero <= 60) return "PSOE";
            else if (numero <= 95) return "VOX";
            else return "SALF";
        }
